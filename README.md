...
- modulo (werkt)
- pointerArgument (failt, vanwege extra store en load)
- prime (failt, want modulo niet geimplementeerd in MIPS (optioneel))
- printf1 (werkt)
- printf2 (werkt)
- printf3 (werkt)
- scanf1 (werkt)
- scanf2 (failt, vanwege %5s (we wisten niet dat we dit moesten supporten))
- scoping (werkt)
- unaryOperations (werkt)
- variables1 (werkt)
- variables2 (werkt)
...
- variables4 (werkt)
- variables5 (werkt)
- variables6 (werkte vroeger, maar door verandering is er een kleine fout)
- variables7 (werkt)
- variables8 (crasht, array indexeren met een non-literal werkt niet in MIPS)
- while (werkt)