; ModuleID = './src/tests/benchmarks/CorrectCode/binaryOperations2.c'
source_filename = "./src/tests/benchmarks/CorrectCode/binaryOperations2.c"
...
define i32 @main() #0 {
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 10)
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 10)
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 10)
  ret i32 1
}
