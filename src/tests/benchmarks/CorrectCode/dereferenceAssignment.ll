; ModuleID = './src/tests/benchmarks/CorrectCode/dereferenceAssignment.c'
source_filename = "./src/tests/benchmarks/CorrectCode/dereferenceAssignment.c"
...
define i32 @main() #0 {
  ...
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %14)
