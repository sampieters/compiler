; ModuleID = './src/tests/benchmarks/CorrectCode/forwardDeclaration.c'
source_filename = "./src/tests/benchmarks/CorrectCode/forwardDeclaration.c"
...
define void @g() #0 {
  ...
  call void @f()
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0))
  ret void
}
