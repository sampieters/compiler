; ModuleID = './src/tests/benchmarks/CorrectCode/ifElse.c'
source_filename = "./src/tests/benchmarks/CorrectCode/ifElse.c"
...
; <label>:17:                                     ; preds = %12
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0))
  br label %19
