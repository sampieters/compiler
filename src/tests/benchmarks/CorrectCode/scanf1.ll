; ModuleID = './src/tests/benchmarks/CorrectCode/scanf1.c'
source_filename = "./src/tests/benchmarks/CorrectCode/scanf1.c"
...
define i32 @main() #0 {
  ...
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0), i32 %6, i32 %7)
  ret i32 1
}
