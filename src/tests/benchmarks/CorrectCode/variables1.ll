; ModuleID = './src/tests/benchmarks/CorrectCode/variables1.c'
source_filename = "./src/tests/benchmarks/CorrectCode/variables1.c"
...
define i32 @main() #0 {
  ...
  %7 = sext i8 %6 to i32
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32 %4, double %5, i32 %7)
  ret i32 0
}
