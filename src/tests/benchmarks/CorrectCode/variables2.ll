; ModuleID = './src/tests/benchmarks/CorrectCode/variables2.c'
source_filename = "./src/tests/benchmarks/CorrectCode/variables2.c"
...
define i32 @main() #0 {
  ...
  %8 = sext i8 %7 to i32
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32 %4, double %6, i32 %8)
  ret i32 0
}
